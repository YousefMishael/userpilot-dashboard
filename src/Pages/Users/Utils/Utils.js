...
export const DEFAULT_TABLE_ROWS_NUM = 8;

//to get random user we just need to pass rowNum as 0
//to get all users let default values the same
export async function getUsers(
  rowsNum = DEFAULT_TABLE_ROWS_NUM,
  filterBy = {},
  page = 0,
  url = "https://randomuser.me/api"
) {
  if (rowsNum) url += `?results=${rowsNum}`;
  if (page) url += "&page=" + page;
  if (filterBy.gender) url += "&gender=" + filterBy.gender.toLowerCase();
  if (filterBy.nationality) url += "&nat=" + filterBy.nationality.toLowerCase();
